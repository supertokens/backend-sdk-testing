...
describe(`dashboardTests: ${printPath("[test/dashboard/dashboard.api.test.js]")}`, function () {
    ...
    describe("multitenancy", function () {
        ...
        //     it("test delete non-existing config from core", async function () {});

        //     it("test deleting config when thirdParty is not initialised", async function () {});
        // });

        // describe("getTenantInfo", function () {
        //     it("test get public tenant info", async function () {});

        //     it("test get non-public tenant info", async function () {});
